...
def accumulate(merger, start, n, term):
    ...
    if n == 0:
        ...
        return merger(start, term(1))
    else:
        last = accumulate(merger, start, n - 1, term)
        return merger(last, term(n))
...
def funception(func1, start):
    ...
    def func2(stop):
        if start < 0:
            return None
        elif start >= stop or stop - 1 == start:
            return func1(start)
        else:
            return func1(stop - 1) * func2(stop - 1)
    return func2
