...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    points_scored = 3*abs(opponent_score // 10 % 10 - player_score % 10)
    if points_scored:
...
def is_always_roll(strategy, goal=GOAL):
    ...
    ref = strategy(score, opponent_score)
    while score < goal:
        while opponent_score < goal:
            if ref != strategy(score, opponent_score):
                return False
            ref = strategy(score, opponent_score)
            opponent_score += 1
        opponent_score = 0
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    average_score, rolls, max_scoring_rolls = 0, 1, 1
    averaged_dice = make_averaged(roll_dice, total_samples)
    while rolls <= 10:
        temp_score = averaged_dice(rolls, dice)
        if average_score < temp_score:
...
def fuzzy_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    score_increased = fuzzy_update(0, score, opponent_score, dice=six_sided) - score 
    if score_increased >= threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if fuzzy_update(0, score, opponent_score, dice=six_sided) >= 100:
        return 0
    elif fuzzy_update(1, score, opponent_score, dice=six_sided) >= 100:
        return 1
    elif fuzzy_update(2, score, opponent_score, dice=six_sided) >= 100:
        return 2
    else:
        return 6
