...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    # loki_tree = []
    # for b in branches(t):
    #     bs = [replace_loki_at_leaf(b, lokis_replacement)]
    #     loki_tree += bs
    # return tree(label(t), loki_tree)
...
def distance(city_a, city_b):
    ...
    sum_of_square = (lat_a - lat_b)**2 + (lon_a - lon_b)**2
...
def closer_city(lat, lon, city_a, city_b):
    ...
    da = distance(city, city_a)
    db = distance(city, city_b)
    if da < db:
